...
function renderProjectPage(){
  ...
  mount.innerHTML=`<div class="project-page-wrap project-page-clean ci-project-v2">
    <style>
      ...
      .ci-project-v2 .ci-header,.ci-project-v2 .ci-row{display:grid!important;grid-template-columns:minmax(0,2.45fr) minmax(90px,1fr) minmax(90px,.9fr) minmax(145px,1.35fr) minmax(105px,1.05fr) 42px!important;column-gap:18px!important;align-items:start!important;box-sizing:border-box!important}
      .ci-project-v2 .ci-header{align-items:center!important;padding:11px 0!important;border-bottom:1px solid var(--line)!important}
      .ci-project-v2 .ci-header span{font-size:8px!important;letter-spacing:.12em!important;color:#999!important}
      .ci-project-v2 .ci-row{position:relative!important;min-width:0!important;padding:18px 0!important;align-items:start!important;border-bottom:1px solid var(--line)!important;background:transparent!important}
      .ci-project-v2 .ci-product{display:flex!important;align-items:center!important;align-self:center!important;gap:12px!important;min-width:0!important;color:inherit!important;text-decoration:none!important}
      ...
      .ci-project-v2 .ci-value{min-width:0!important;align-self:start!important;font-size:11px!important;line-height:1.35!important;color:var(--ink)!important;background:transparent!important;padding:0!important;border:0!important;overflow:visible!important;white-space:normal!important;display:block!important}
      .ci-project-v2 .ci-value strong{display:block!important;width:max-content!important;max-width:100%!important;margin:0!important;padding:0!important;background:transparent!important;border:0!important;font-size:11px!important;line-height:16px!important;font-weight:500!important;color:var(--ink)!important;white-space:nowrap!important}
      .ci-project-v2 .ci-secondary{display:block!important;width:max-content!important;max-width:100%!important;margin:3px 0 0!important;padding:0!important;background:transparent!important;border:0!important;font-size:8px!important;line-height:1.25!important;font-weight:400!important;color:#999!important;white-space:nowrap!important}
      .ci-project-v2 .ci-buy strong{font-size:11px!important;line-height:16px!important;font-weight:500!important}
      .ci-project-v2 .ci-buy .ci-secondary{margin-top:5px!important}
      .ci-project-v2 .ci-edit{justify-self:end!important;align-self:center!important;width:34px!important;height:34px!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;border:1px solid var(--line)!important;background:transparent!important;color:var(--ink)!important;font:inherit!important;font-size:16px!important;line-height:1!important;padding:0!important;cursor:pointer!important;white-space:nowrap!important}
      ...
      ${items.length?`<div class="project-products-list ci-table">
        ...
        ${items.map((item,index)=>{
          ...
          return `<article class="project-product-row ci-row" data-item-id="${esc(item.id)}">
            ...
            <div class="project-summary ci-value ci-purchase"><strong>${purchaseCaption}</strong>${purchaseSub?`<span class="ci-secondary">${esc(purchaseSub)}</span>`:''}</div>
            <div class="project-summary project-buy-result ci-value ci-buy"><strong>${esc(buyLabel)}</strong>${wasteActive&&waste?`<span class="ci-secondary">${esc(`${cleanNumber(calculated)} ${unit} con merma`)}</span>`:''}</div>
